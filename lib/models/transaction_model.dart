class instapayModel {
  ...
  instapayModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
  ...
  DateTime get transactionDateTime {
    try {
      return DateTime.parse(transactionDate); // Assumes ISO format
    } catch (e) {
      throw Exception('Invalid transactionDate format: $transactionDate');
    }
  }
}
